const scope = {
  ...
  exerciseG() {
    ...
    // Annotation:
    //LogA is ref error because a non-existent variable is referenced
    //LogB is mango because before we hit the reference error on line 271, it was mango so, at this point in time it is still mango
    //LogC is still mango at this point in time and we are still inside the func
    //LogD is apple because we are now in the global scope and look to the global parent which is apple
  },
